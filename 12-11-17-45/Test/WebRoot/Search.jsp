...
<body>
 ...
 <div class="well well-sm"  style="margin:0 auto;width: 600px; height: 167px">
<div style="margin:0 auto;width:600px;">
<span class="glyphicon glyphicon-user" style="color: rgb(100, 240, 146); font-size: 25px;">
可选老师列表[可点击老师姓名立即预约]：<br><br>
 <%
 int teacher[];
 teacher=new int [5];
 int i=0;
...
<div class="panel panel-danger" style="margin:0 auto;width:700px;height: 200px">
<div class="panel-heading">
<span class="glyphicon glyphicon-search" style="font-size: 35px;"> 输入您想要预约的教师的名字:</span>
</div>
<br><br>
   <div class="panel-body">
	<input type="text" name="name" style="width: 300px; height: 42px">	  
