			...
			if(rs.next())
			{
				...
				teacherid=(rs.getString(2));
				 ...
				 try {
						...
						while(rs1.next())
						{
							ttw.setTime(rs1.getString(2),rs1.getString(9),rs1.getString(8),rs1.getInt(1));
							tt[j].setName(name);
							...
							tt[j].setYear(rs1.getString(8));
							tt[j].setMonth(rs1.getString(9));
							tt[j].setThingsec(rs1.getString(10));
							j++;
